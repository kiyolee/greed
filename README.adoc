...
Note: you need to have asciidoctor installed to build the documentation.

This code is commonly packaged as "greed".

image:https://repology.org/badge/vertical-allrepos/greed.svg[Repology
package status]
