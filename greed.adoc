...
simply use your arrow keys, the 'hjklyubn' keys, or your numeric
...
The -w and -h options set the width and height of the board.
The -f option sizes the board to fit your terminal window.

With option -p, display all your next possible moves
with a reverse-video highlight.  During the game, 'p'
...
Where <cn> is a character describing the color for digit n.
